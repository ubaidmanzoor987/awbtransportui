...
export default function EmploymentHistory(props: Props) {
  ...
  const [employmentHistoryState, employmentHistoryStateHandler] = useState(props.employmentHistoryList);
  ...
  const isPropertyExist = (property: any) => {
    try {
      console.log("-------------------isPropertyExist LOGGING-------------------");
  ...
  const isPropertyExistReturnMessage = (property: any) => {
    try {
      console.log("-------------------isPropertyExistReturnMessage LOGGING-------------------");
      console.log(property);
      if (property === undefined) {
        console.log("-------------------FALSE-------------------");
        console.log(property);
  ...
  return (
    <React.Fragment>
      <Grid container direction="row" justify="space-between" alignItems="center">
        {employmentHistoryState.map((employmentHistoryItem: EmploymentHistoryInfo, index: number) => {
          console.log("----------------------ERRORS----------------------");
          console.log(errors);
                ...
                <Grid container direction="row" justify="space-between" alignItems="baseline" spacing={3}>
                  <Grid item xs={6}>
                    <TextField
                      ...
                      error
                      helperText={
                        errors[props.idPrefix]?.employmentHistoryfrom &&
                        errors[props.idPrefix]?.employmentHistoryfrom[index] &&
                        errors[props.idPrefix]?.employmentHistoryfrom[index].message
                      }
                      inputRef={register({
                        required: {
                  ...
                  <Grid item xs={6}>
                    <TextField
                      ...
                      //useForms Handling Start
                      error={
                        isPropertyExist(errors[props.idPrefix]?.employmentHistoryTo)
                      ...
                      helperText={isPropertyExistReturnMessage(errors[props.idPrefix]?.employmentHistoryTo[index])}
                      inputRef={register({
                        required: {
                  ...
                  <Grid item xs={6}>
                    <TextField
                      ...
                      error={
                        ...
                        errors[props.idPrefix]?.employmentHistorystatus[index] === undefined
                          ? false
                          : true
                      }
                      helperText={
                        ...
                        errors[props.idPrefix]?.employmentHistorystatus[index].message
                      }
                      inputRef={register({
                        required: {
                  ...
                  <Grid item xs={6}>
                    <TextField
                      ...
                      error={
                        ...
                        errors[props.idPrefix]?.employmentHistoryposition[index] === undefined
                          ? false
                          : true
                      }
                      helperText={
                        errors[props.idPrefix]?.employmentHistoryposition &&
                        errors[props.idPrefix]?.employmentHistoryposition[index] &&
                        errors[props.idPrefix]?.employmentHistoryposition[index].message
                      }
                      inputRef={register({
                        required: {
                  ...
                  <Grid item xs={6}>
                    <TextField
                      ...
                      error={
                        ...
                        errors[props.idPrefix]?.employmentHistorycompanyPhone[index] === undefined
                          ? false
                          : true
                      }
                      helperText={
                        errors[props.idPrefix]?.employmentHistorycompanyPhone &&
                        errors[props.idPrefix]?.employmentHistorycompanyPhone[index] &&
                        errors[props.idPrefix]?.employmentHistorycompanyPhone[index].message
                      }
                      inputRef={register({
                        required: {
                  ...
                  <Grid item xs={6}>
                    <TextField
                      ...
                      //useForms Handling Start
                      error={
                        errors[props.idPrefix]?.employmentHistoryreasonForLeaving &&
                        errors[props.idPrefix]?.employmentHistoryreasonForLeaving[index] === undefined
                          ? false
                          : true
                      }
                      helperText={
                        errors[props.idPrefix]?.employmentHistoryreasonForLeaving &&
                        errors[props.idPrefix]?.employmentHistoryreasonForLeaving[index] &&
                        errors[props.idPrefix]?.employmentHistoryreasonForLeaving[index].message
                      }
                      inputRef={register({
                        required: {
                  ...
                  <Grid item xs={8} className={(classes.paper, classes.questionTextStyle)}>
                    <Typography className={classes.text}>Were you subject to the FMCSRs while employed here?</Typography>
                  </Grid>
                  <Grid item xs={4} style={{ textAlign: "right" }}>
                    <FormControl
                      ...
                      error={
                        errors[props.idPrefix]?.employmentHistorysubjecttotheFMCSRs &&
                        errors[props.idPrefix]?.employmentHistorysubjecttotheFMCSRs[index] === undefined
                          ? false
                          : true
                      }
                    >
                      <RadioGroup row>
                        <FormControlLabel
                          value="yes"
                          control={<Radio name={`${props.idPrefix}.employmentHistorysubjecttotheFMCSRs[${index}]`} />}
                          label="Yes"
                        />
                        <FormControlLabel
                          value="no"
                          control={
                            <Radio
                              ...
                              inputRef={register({
                                required: {
                                  value: reqBits.employmentHistorysubjecttotheFMCSRs,
                                  message: RequireError,
                                },
                              })}
                              //useForms Handling End
                      ...
                      <FormHelperText>
                        {errors[props.idPrefix]?.employmentHistorysubjecttotheFMCSRs &&
                          errors[props.idPrefix]?.employmentHistorysubjecttotheFMCSRs[index] &&
                          errors[props.idPrefix]?.employmentHistorysubjecttotheFMCSRs[index].message}
                      </FormHelperText>
                    </FormControl>
                  </Grid>
                  ...
                  <Grid item xs={4} style={{ textAlign: "right" }}>
                    <FormControl
                      component="fieldset"
                      error={
                        errors[props.idPrefix]?.employmentHistorydrugandalcoholTesting &&
                        errors[props.idPrefix]?.employmentHistorydrugandalcoholTesting[index] === undefined
                          ? false
                          : true
                      }
                    >
                      ...
                      >
                        <FormControlLabel
                          value="yes"
                          control={<Radio name={`${props.idPrefix}.employmentHistorydrugandalcoholTesting[${index}]`} />}
                          label="Yes"
                        />
                        <FormControlLabel
                          value="no"
                          control={
                            <Radio
                              ...
                              inputRef={register({
                                required: {
                                  value: reqBits.employmentHistorydrugandalcoholTesting,
                                  message: RequireError,
                                },
                              })}
                              //useForms Handling End
                      ...
                      <FormHelperText>
                        {errors[props.idPrefix]?.employmentHistorydrugandalcoholTesting &&
                          errors[props.idPrefix]?.employmentHistorydrugandalcoholTesting[index] &&
                          errors[props.idPrefix]?.employmentHistorydrugandalcoholTesting[index].message}
                      </FormHelperText>
                    </FormControl>
                  </Grid>
                  {/* <Grid item xs={1}></Grid> */}
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      if (employmentHistoryState.length > 1) {
                        const employmentHistoryStateCopy = [...employmentHistoryState];
                        employmentHistoryStateCopy.splice(index, 1);
                        employmentHistoryStateHandler([...employmentHistoryStateCopy]);
                      }
                    }}
                  >
                    Delete This
        ...
        <Grid item xs={12} style={{ padding: "20px 10px" }}>
          <Button
            ...
            color="primary"
            onClick={(e) => {
              employmentHistoryStateHandler([...employmentHistoryState, employmentHistoryDummyElement]);
