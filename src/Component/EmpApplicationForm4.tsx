...
export default function EmpApplicationForm4() {
                    ...
                    <ol>
                      <li>
                        <b>
                          ...
                          This policy only discusses the FMCSA provisions of the mandated drug and alcohol testing regulations and
                          how they relate to employees. Portions of this policy that exceed Department of Transportation rules and
                          regulations are in bold.
                        </b>
                      </li>
                      <li>
                        The provisions contained in the Company Anti-Drug/Alcohol Misuse Prevention Plan (AMPP) are applicable to
                        those Company employees who perform safety-sensitive trucking functions covered under 49 CFR Part 382.
                        This policy will also be in effect for any employee who hold a Class B or C drivers license.
                        <b>
                      ...
                      <li>
                        ...
                        discussed in the Company policy and must be aware of the specific highway regulations as set forth in this
                        policy.
                      </li>
                      <li>
                        ...
                        light of the above, the Company has adopted this plan to specify the circumstances under which testing may
                        be required, the procedures for conducting such testing and the methods and procedures for complying with
                        the requirements of the Federal Motor Carrier Safety Administration regulations.
                      </li>
                      <li>
                        The Company will implement necessary and reasonable measures to maintain a work environment, free of drugs
                        and alcohol. Employees with drug and alcohol misuse problems are strongly encouraged to seek assistance.
                      </li>
                      <li>
                  ...
                  <Typography align="justify" variant="body2">
                    <ol>
                      ...
                      <li>
                        ...
                        employees who perform safety-sensitive trucking functions shall be subject to the drug and alcohol misuse
                        testing provisions.
                      </li>
                  ...
                  <Typography align="justify" variant="body2">
                    <ol>
                      <li>
                        ...
                        knowledge of a driver using a controlled substance or alcohol to permit the driver to perform or continue
                      ...
                      <li>
                        ...
                        functions covered under 49 CFR Parts 382 and 383, and who meet the definition of "Driver" in D.6. of this
                        section.
                      </li>
                      <li>
                        <b>Alcohol Prohibitions.</b>
                      ...
                      <ol type="a">
                        ...
                        <li>No driver shall be on duty, as defined in 395.2, if the driver tests positive for use of alcohol.</li>
                        <li>
                        ...
                        <li>
                          It is against policy to allow any driver that has a Breath-Alcohol Content (BrAC) of .02 -039 grams per
                          210 liters of breath to operate any vehicle. An employee with a BrAC of .02-.039 must be removed from
                          duty for one shift or 24 hours. Upon return to work the employee must have a BrAC below .02.
                        </li>
                        <li>
