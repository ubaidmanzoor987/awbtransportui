...
//   socialSecurity: string,
// ): Data {
//   return { first_name, last_name, email, gender, socialSecurity };
// }
...
//   { id: 'socialSecurity', numeric: false, disablePadding: false, label: 'Social Security' },
// ];
...
//                 .map((row, index) => {
//                   const isItemSelected = isSelected(props.row.name);
//                   const labelId = `enhanced-table-checkbox-${index}`;

//                   return (
//                     <TableRow
//                       hover
//                       onClick={(event) => handleClick(event, props.row.name)}
//                       role="checkbox"
